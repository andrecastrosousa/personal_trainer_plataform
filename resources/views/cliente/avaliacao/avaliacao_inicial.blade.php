...
@section('content')
    <div class="avaliacao">
        <div class="offset-md-2 col-md-8" style="padding: 25px;">
            <form action="{{ route('avaliacao_inicial.store') }}" enctype="multipart/form-data" method="post">
                {{csrf_field()}}
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input class="form-control @error('data_nascimento') is-invalid @enderror" type="date" id="data_nascimento" name="data_nascimento" value="{{old('data-nasc')}}">
