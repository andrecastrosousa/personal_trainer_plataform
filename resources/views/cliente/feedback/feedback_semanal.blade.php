            ...
            <form action="{{ route('feedback.store') }}" enctype="multipart/form-data" method="post">
                ...
                <div>
                        ...
                        <div class="col-md-12 ml-4 text-center">
                            ...
                            <div class="row col-md-12 mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="outra_opiniao" value="{{old('outra_opiniao')}}">
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea class="form-control" type="text" id="feedback" name="feedback">{{old('feedback')}}</textarea>
                        </div>
                    </div>
